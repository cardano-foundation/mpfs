...
const config: Config = {
  title: 'MPFS',
  tagline: 'Merkle Patricia Forestries on Cardano',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/cardano-foundation/mpfs/tree/main/docs/',
        },
        blog: {
          routeBasePath: '/blog',
  ...
  themeConfig: {
    ...
    metadata: [
      { name: 'description', content: 'HTTP service around merkle-patricia-forestries on Cardano' },
    ],
    navbar: {
      title: 'MPFS',
      logo: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/cardano-foundation/mpfs',
          label: 'GitHub',
          position: 'right',
        },
      ],
